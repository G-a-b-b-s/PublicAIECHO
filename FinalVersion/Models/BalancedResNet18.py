...
def main():
    ...
    logs_base_model = "/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/Balanced"
    ...
    class_report = classification_report(test_labels, predicted_labels, target_names=["Normal", "HFrEF", "HFpEF", "HFmrEF"])
