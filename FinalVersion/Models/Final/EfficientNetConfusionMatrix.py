...
def main():
    ...
    class_weights = {0: 1/624, 1:1/1370, 2:1/1268, 3:1/506}
    ...
    for model_name, model in models.items():
        logs_base_model = f"/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/Final/{model_name}_batched"
        ...
        for fold in range(num_folds):
            ...
            train_loader = DataLoader(train_ds, batch_size=16, sampler=trainSampler, num_workers=4)
        ...
        for i in range(len(test_labels)):
            ...
            predicted_label = np.argmax(ensemble_predictions[i])
