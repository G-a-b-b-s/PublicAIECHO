...
def main():
    ...
    models = {
        "EfficientNetB3_droppath3": timm.create_model("efficientnet_b3", pretrained=True, in_chans=30, num_classes=4,drop_path_rate = 0.3).to(device),
        "EfficientNetB3_drophead3": timm.create_model("efficientnet_b3", pretrained=True, in_chans=30, num_classes=4,drop_rate = 0.3).to(device),
        "EfficientNetB3_droppath4": timm.create_model("efficientnet_b3", pretrained=True, in_chans=30, num_classes=4,
                                                      drop_path_rate=0.4).to(device),
        "EfficientNetB3_drophead4": timm.create_model("efficientnet_b3", pretrained=True, in_chans=30, num_classes=4,
    ...
    for model_name, model in models.items():
        logs_base_model = f"/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/Final/{model_name}_dropout"
