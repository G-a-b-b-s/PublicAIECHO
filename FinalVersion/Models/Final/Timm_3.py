...
def main():
    ...
    models = {
        ...
        "VisionTransformer": timm.create_model('davit_tiny', pretrained=True, in_chans=30, num_classes=4).to(device),
        "Vit_dino": timm.create_model('vit_base_patch14_dinov2', pretrained=True, in_chans=30, num_classes=4).to(device),
        "EfficientNetViT": timm.create_model('efficientvit_b3', pretrained=True, in_chans=30, num_classes=4).to(
            device),
        'Nextvit_small': timm.create_model('nextvit_small', pretrained=True, in_chans=30, num_classes=4).to(
            device),
