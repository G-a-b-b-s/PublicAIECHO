...
def main():
    ...
    models = {
        ...
        "Gcvit_small": timm.create_model("gcvit_small", pretrained=True, in_chans=30, num_classes=4).to(device),
        "Gcvit_xxtiny": timm.create_model("gcvit_xxtiny", pretrained=True, in_chans=30, num_classes=4).to(device),
        "Inception_next_base": timm.create_model("inception_next_base", pretrained=True, in_chans=30, num_classes=4).to(device),
        "Inception_next_small": timm.create_model("inception_next_small", pretrained=True, in_chans=30, num_classes=4).to(device),
        "Tiny_vit_21m_224": timm.create_model("tiny_vit_21m_224", pretrained=True, in_chans=30, num_classes=4).to(device),
    }
    ...
    for model_name, model in models.items():
        logs_base_model = f"/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/Final/{model_name}"
