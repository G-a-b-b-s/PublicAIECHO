...
def main():
    ...
    models = {
        "ResNet18": timm.create_model("resnet18", pretrained=True, in_chans=30, num_classes=4,drop_path_rate=0.3).to(device),
        "ResNet50d": timm.create_model("resnet50d", pretrained=True, in_chans=30, num_classes=4,drop_path_rate=0.3).to(device),
        "EfficientNetB0": timm.create_model("efficientnet_b0", pretrained=True, in_chans=30, num_classes=4,drop_path_rate=0.3).to(device),
        "InceptionV3": timm.create_model("inception_v3", pretrained=True, in_chans=30, num_classes=4,drop_path_rate=0.3).to(device),
    }
    ...
    for model_name, model in models.items():
        logs_base_model = f"/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/Final/{model_name}_drop_path_rate"
