...
def main():
    ...
    class_weights = {0: 1/645, 1:1/1370, 2:1/1268, 3:1/506}
    ...
    for model_name, model in models.items():
        logs_base_model = f"/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/Final/{model_name}_weighted"
        ...
        for fold in range(num_folds):
            ...
            weights = torch.tensor([1 / 331, 1 / 1370, 1 / 1268, 1 / 506]).to(device)
