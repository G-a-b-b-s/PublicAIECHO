...
def main():
    ...
    logs_base_model = "/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/ResNet50"
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(train_data)):
        ...
        for epoch in range(50):
            ...
            if val_auc > best_auc:
                best_auc = val_auc
                patience_counter = 0
                model_path = os.path.join(logs_base_model, f"Best_resnet50_fold{fold + 1}.pth")
    ...
    for fold in range(num_folds):
        ...
        best_model_path = os.path.join(logs_base_model, f"Best_resnet50_fold{fold + 1}.pth")
