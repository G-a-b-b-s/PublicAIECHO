...
def main():
    ...
    alpha = [0.30, 0.2, 0.2, 0.3]

    for gamma in [2, 3, 5, 10]:
        logs_base_model = f"/net/tscratch/people/plggabcza/AIECHO/Training_logs_updated/FocalLos_{gamma}"
        ...
        criterion = FocalLoss(gamma=gamma, alpha=torch.tensor(alpha))
